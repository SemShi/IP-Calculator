namespace IP_Calculate
{
    public partial class Form1 : Form
    {
        ...
        private void âûéòèÈçÏðîãðàììûToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void àâòîðToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Ïðèëîæåíèå ñîçäàíî ñòóäåíòîì ãðóïïû ÝÈÑÁ-24, Øèøêèíûì Ñ.Í.", "Î ïðîãðàììå");
        }
